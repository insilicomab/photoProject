...
SECRET_KEY = 'django-insecure-gr^d9b7^!dj=vaor#$dcw^ijckb7f5^b%3g4ew__hlrwt@@2+k'
...
EMAIL_HOST_USER = 'photo@gmail.com'                # Gmailのアドレス
EMAIL_HOST_PASSWORD = 'password'                   # Gmailのアプリ用パスワード
